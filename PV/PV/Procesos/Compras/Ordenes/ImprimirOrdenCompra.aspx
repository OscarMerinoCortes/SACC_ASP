<%@ Page Title="Imprimir Orden" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ImprimirOrdenCompra.aspx.vb" Inherits="PV.ImprimirOrdenCompra" %>
				...
				<table style="width: 100%;">
					...
					<tr>
						<td colspan="3">
							...
							<asp:Label ID="Label12" runat="server" Font-Bold="True" Text="Reimprimir orden de compra"></asp:Label>
